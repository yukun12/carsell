...
<div class="shoubu"style="text-align:center;font-size:30px;">
	...
	<p>|</p>
	<p class="logo" style="font:700 1.5em Raleway,Arial,Helvetica;position:relative;left:-60px;top:10px;">LaoBan</p>
...
<div class="wrap">
	<div class="footer">
	    ...
	    <script type="text/javascript">
		 ...
		 <a href="home.jsp" id="toTop" style="display: block;height:34px;width:34px;">
