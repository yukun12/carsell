...
<section class="wrapper">
                ...
                <li style="background:gray;">
                    <a href="#" title="Tables" data-toggle="collapse-next" class="has-submenu"
                       style="color:white; box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
                        ...
                        <span class="item-text" style="font-size:17px;">用户管理</span>                  </a>
                    <!-- START SubMenu item-->
                    <ul class="nav collapse ">
                        <li>
                            <a href="/page/bhistory" style="color:white; box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
                                <span class="item-text" style="font-size:17px;">所有</span>                  </a>
                        </li>
                    </ul>
                </li>
                <li>
    ...
    <section>
        ...
        <section class="main-content">
            <h3>历史订单
                <br>
                <small>可管理已完成的订单信息</small>
            </h3>
            <!-- START panel-->
            <div class="panel panel-default">
                <div class="panel-heading">已完成订单
