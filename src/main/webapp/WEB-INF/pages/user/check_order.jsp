            ...
            <ul class="nav">
               ...
               <li style="background:gray;">
                  ...
                  <ul class="nav collapse ">
                     ...
                     <li>
                     <li style="background:gray;">
                        <a href="/page/check_order" style="color:white; box-shadow: 0px 1px 10px rgba(0,0,0,.8);">
                           <span class="item-text" style="font-size:17px;">订单确认</span>                        </a>                     </li>
                     <li>
  ...
  <!-- END Main wrapper-->
   ...
   <script type="text/javascript">
       $(function(){
           ...
           $("#table-id").on("click","a#check",function(){
//               alert(321);
